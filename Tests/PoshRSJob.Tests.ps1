...
Import-Module $PSScriptRoot\..\PoshRSJob\PoshRSJob -Force -verbose
...
Describe "PoshRSJob PS$PSVersion" {
    ...
    Context 'Strict mode' {
        ...
        It 'should load all functions' {
            $Commands = @( Get-Command -Module PoshRSJob | Select -ExpandProperty Name)
